...
@HippoEssentialsGenerated(internalName = "world:bannerdocument")
@Node(jcrType = "world:bannerdocument")
public class Banner extends BaseDocument {
	...
	public HippoGalleryImageSet getImage() {
		return getLinkedBean("world:image", HippoGalleryImageSet.class);
	}

	@HippoEssentialsGenerated(internalName = "world:link")
	public HippoBean getLink() {
		return getLinkedBean("world:link", HippoBean.class);
	}
}
