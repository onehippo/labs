...
@HippoEssentialsGenerated(internalName = "europe:author")
@Node(jcrType = "europe:author")
public class Author extends HippoDocument implements AuthorEntry {

    public static final String ROLE = "europe:role";
    public static final String ACCOUNTS = "europe:accounts";
    public static final String FULL_NAME = "europe:fullname";
    public static final String IMAGE = "europe:image";
    public static final String CONTENT = "europe:content";

    @HippoEssentialsGenerated(internalName = "europe:fullname")
    ...
    @HippoEssentialsGenerated(internalName = "europe:role")
    ...
    public HippoGalleryImage getImage() {
  	...
  	@HippoEssentialsGenerated(internalName = "europe:accounts")
