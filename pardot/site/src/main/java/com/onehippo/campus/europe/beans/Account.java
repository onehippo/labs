...
@HippoEssentialsGenerated(internalName = "europe:account")
@Node(jcrType = "europe:account")
public class Account extends HippoCompound {

    public static final String TYPE = "europe:type";
    public static final String LINK = "europe:link";

    @HippoEssentialsGenerated(internalName = "europe:type")
