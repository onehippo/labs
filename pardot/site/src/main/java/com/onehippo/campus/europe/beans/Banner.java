...
@HippoEssentialsGenerated(internalName = "europe:bannerdocument")
@Node(jcrType = "europe:bannerdocument")
public class Banner extends BaseDocument {
	...
	public HippoGalleryImageSet getImage() {
		return getLinkedBean("europe:image", HippoGalleryImageSet.class);
	}

	@HippoEssentialsGenerated(internalName = "europe:link")
	public HippoBean getLink() {
		return getLinkedBean("europe:link", HippoBean.class);
	}
}
